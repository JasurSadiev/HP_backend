...
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\Linear_regressor_model.pkl', 'rb') as file:
    linear_model = pickle.load(file)
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\DecisionTreeRegressor_model.pkl', 'rb') as file1:
    decision_tree_model = pickle.load(file1)
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\RandomForestRegressor_model.pkl', 'rb') as file2:
    random_forest_model = pickle.load(file2)

# with open('CatBoostRegressor_model.pkl', 'rb') as file3:
#     catboost_model = pickle.load(file3)
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\lgbm_model.pkl', 'rb') as file4:
    lgbm_model = pickle.load(file4)

# Load label encoders
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\district_encoder.pkl', 'rb') as file5:
    district_encoder = pickle.load(file5)
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\micro_district_encoder.pkl', 'rb') as file6:
    micro_district_encoder = pickle.load(file6)
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\building_type_encoder.pkl', 'rb') as file7:
    building_type_encoder = pickle.load(file7)
with open(r'C:\Users\jasurbek.sadiev\PycharmProjects\PredictHouse(Backend)\project_name\house_prediction\static\condition_encoder.pkl', 'rb') as file8:
